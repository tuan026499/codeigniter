        ...
        $routes->post('post-register','Admin\LoginController::save_register');
            ...
            $routes->get('logout','Admin\LoginController::logout');
                $routes->group('users',function ($routes) {
                    ...
                    $routes->get('user-create','Admin\UserController::create_user');
                    $routes->post('save-user','Admin\UserController::save_user');
                    $routes->get('edit-user/(:num)','Admin\UserController::edit/$1');
                    $routes->post('edit-user/(:num)','Admin\UserController::update_user/$1');
